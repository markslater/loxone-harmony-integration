...
class OaIdentityTest {
    ...
    void parsingInvalidXmlThrowsOaIdentityParseException() throws Exception {
        OaIdentity.OaIdentityParseException exception = assertThrows(OaIdentity.OaIdentityParseException.class, () -> OaIdentity.parseHarmonyHubResponse("barf").asString());
    ...
    void parsingResponseWithNoContentThrowsOaIdentityParseException() throws Exception {
        OaIdentity.OaIdentityParseException exception = assertThrows(OaIdentity.OaIdentityParseException.class, () -> OaIdentity.parseHarmonyHubResponse("<oa xmlns='connect.logitech.com' mime='vnd.logitech.connect/vnd.logitech.pair' errorcode='200' errorstring='OK'/>").asString());
